...
using Roommates_2nd_version_.Repositories;
...
namespace Roommates.Repositories
{
    public class RoommateRepository : BaseRepository
    {
        ...
        {
            //opening a connection with ado .net that connects csharp and sql database
            using (SqlConnection conn = Connection)
            {
                conn.Open();

                //gives us the ability to write sql in our code
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    //reading the data you get from sql and putting in an object
